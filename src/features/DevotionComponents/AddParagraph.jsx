...
const AddParagraph = ({ handleParaChange, addPara, paragraphs, deletePara }) => {


  return (
    <div className='space-y-3'>
        <button type='button' onClick={addPara} className='bg-gray-500 p-1 rounded-sm cursor-pointer'>
            Add Paragraph
        </button>
        {paragraphs.map((para, paragraphIndex) => (
            <div key={paragraphIndex} className='flex'>
                ...
                />
                 <FaTrash onClick={() => deletePara(paragraphIndex)} className=' text-gray-700 text-xl cursor-pointer self-center' />
