  ...
  return (
    <div className=" mx-auto home-page-img ">
        ...
        <div className="flex flex-col-reverse  md:flex-row justify-between md:items-center w-[80%] md:mx-auto</div>">
            ...
            <span className="font-bold text-2xl">“</span> <span className="font-nokia-light">ዕዝራም የእግዚአብሔርን ሕግ <span className="text-accent-5 font-nokia-bold">ይፈልግና ያደርግ ዘንድ፥</span> ለእስራኤልም ሥርዓትንና ፍርድን <span className="text-accent-5 font-nokia-bold">ያስተምር ዘንድ</span> ልቡን አዘጋጅቶ ነበር።</span><span className="font-bold text-2xl"> ”</span> <span className="text-accent-5 font-nokia-bold">ዕዝራ 7:10</span>
            </p>
            </div>
            ...
            <h1 className="text-4xl md:text-7xl font-Lato-Black text-white">
                Study The <br/> Bible On <br/><span className="text-accent-5">Your Phone</span>
            </h1>
