...
const Signup = () => {
  ...
  return (
    ...
    <div className="md:flex flex-col bg-coming-soon bg-cover hidden lg:w-[40%] font-nokia-bold p-7 justify-between text-white rounded-xl gap-64" style={{backgroundPositionX:"-80px"}}>
